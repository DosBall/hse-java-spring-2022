...
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 02.02 &mdash; Создать репозиторий <br> 11.02 — Проектная документация | https://github.com/DosBall/java-cell-auto-sim | |
